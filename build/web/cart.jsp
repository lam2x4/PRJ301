<%-- 
    Document   : cart
    Created on : Jul 13, 2022, 5:01:11 PM
    Author     : ADMIN
--%>
                                            ...
                                            <tr>
                                                <td class="product__cart__item">
                                                    <div class="product__cart__item__pic">
                                                        <img src="${i.product.images}" style="width: 90px; height: 90px" alt="">
                                                    </div>
                                                ...
                                                <td class="cart__price">${i.quantity*i.price}đ</td>
                                                <td class="cart__close"><a href="updatecart?delete=${i.product.id}"><i class="fa fa-close"></a></i></td>
                                            </tr> 
                                        </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="cart__total">
                            ...
                            <ul>
                                ...
                                <li>Total <span>${o.getTotalMoney()}</span></li>
                            </ul>
