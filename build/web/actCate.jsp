                ...
                <div class="col-md-2 container_option">
                    ...
                    <div class="option">
                        <ul class="option-nav">
                            ...
                            <li class="active"><a href=""><i class="fa-solid fa-layer-group"></i>Category group</a></li>
                ...
                <div class="col-md-10 container_content">
                    ...
                    <div class="container2">
                        <form action="actcate">
                            ...
                            <input hidden type="text" name="id" value="${requestScope.id}"/>
                            <input hidden type="text" name="action" value="${requestScope.action}"/>
                            <br/><!-- comment -->
