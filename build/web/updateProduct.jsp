                ...
                <div class="col-md-10 container_content">
                    ...
                    <div class="container2">
                        ...
                        <form action="update" method="post">
                            ...
                            Ảnh <input type="file" id="file-upload" name="image" value="${p.images}"/><br/>
                            Enter category:<select name="category">
                                <c:forEach items="${requestScope.listCategory}" var="c">
                                    <option value="${c.id}" ${p.category == c.name?"selected":""}>${c.name}</option>
                                </c:forEach>
                            </select><br/>

                            Enter brand: <select name="brand">
                                <c:forEach items="${requestScope.listBrand}" var="b">
                                    <option value="${b.id}" ${p.brand == b.name?"selected":""}>${b.name}</option>
                                </c:forEach>
                            </select><br/>
                            ...
                            Enter releaseDate:<input type="date" name="releaseDate" value="${p.releaseDate}"/><br/>
