...
<html lang="zxx">
    ...
    <body>
        ...
        <div class="container1">
            <div class="row">
                <div class="col-md-2 col-lg-2 container_option">
                    <div class="head">
                    ...
                    <div class="option">
                        <ul class="option-nav">
                            ...
                            <li class="active"><a href="blog"><i class="fa-brands fa-blogger"></i>Blog</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-10 col-lg-10 container_content">
