            ...
            <div class="row">
                <div class="col-md-2 container_option">
                    ...
                    <div class="option">
                        <ul class="option-nav">
                            ...
                            <li class="active"><a href="catetable"><i class="fa-solid fa-layer-group"></i>Category group</a></li>
                ...
                <div class="col-md-10 container_content">
                    ...
                    <div class="container2">
                        <div><button style="padding: 0;"><a href="catetable?action=Add" style="background: white;">Add Category</a></button></div>
                        <div class="row card1">
                            <c:forEach items="${requestScope.dataCategory}" var="c">
                                <div class="col-md-4 cart-body">
                                <div class="cart-body-item">
                                    <h5>${c.name}</h5>
                                    <button><a href="catetable?action=Update&id=${c.id}">Edit</a></button>
                                    <button><a href="catetable?action=delete&id=${c.id}">Delete</a></button>
                                </div>
                            </div>
                            </c:forEach>
                        </div>
